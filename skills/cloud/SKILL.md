---
name: cloud
description: Design cloud-native architectures and generate IaC (Terraform, CloudFormation, Bicep, CDK) for AWS, Azure, and GCP. Use for cloud design, infrastructure as code, Well-Architected reviews, migration planning, cost analysis, or disaster recovery design.
---
