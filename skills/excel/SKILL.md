---
name: excel
description: Read Excel (.xlsx, .xls) and CSV files and convert them to markdown tables for use in architecture analysis. Use when importing spreadsheet data such as capacity numbers, cost models, or structured datasets into the architecture workflow.
---
