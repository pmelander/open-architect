---
name: adr
description: Create and manage Architecture Decision Records (ADRs) capturing context, options considered, and rationale. Use when recording, reviewing, or querying architectural decisions.
---
