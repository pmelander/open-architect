---
name: solution-doc
description: Generate architecture documentation — HLDs, LLDs, deployment guides, and runbooks. Use when asked to produce solution documentation, high-level or low-level designs, deployment plans, or operational runbooks.
---
