---
name: design-review
description: Review architecture designs critically and systematically for production readiness. Use when asked to review a design, evaluate an architecture, or run a pre-production design review.
---
